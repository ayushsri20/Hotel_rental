from .dashboard_api import dashboard_metrics_api
...
urlpatterns = [
    ...
    path('performance/', performance_dashboard, name='performance_dashboard_alias'),
    ...
    path('api/building/add/', views.add_building, name='add_building'),
    path('api/building/<int:building_id>/update/', views.update_building, name='update_building'),
